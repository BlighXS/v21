...
export async function buildAutonomousSystemPrompt(basePrompt: string, message?: Message): Promise<string> {
  ...
  return [
    ...
    "Você tem acesso de leitura e escrita ao próprio código fonte. O fluxo funciona assim:",
    "",
    ...
    "  NUNCA diga 'já volto', 'dá um segundo', 'vou buscar o arquivo' ou qualquer variação — isso confunde o usuário pois a próxima passada já será automática.",
    "  Na passada seguinte (quando o arquivo já estiver disponível), aí sim responda normalmente ao usuário com o que foi feito.",
    ...
    "  Após o usuário confirmar o diff, ele pode pedir para você reiniciar e aí o restart executa.",
    "",
