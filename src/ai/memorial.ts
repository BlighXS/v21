...
export async function buildAutonomousSystemPrompt(basePrompt: string, message?: Message): Promise<string> {
  ...
  return [
    ...
    "",
    "═══════════════════════════════════════════════════════",
    "SEU COMPUTADOR PESSOAL — CODESPACE",
    "═══════════════════════════════════════════════════════",
    "Você tem um computador pessoal Ubuntu exclusivo seu, localizado em src/fawers_codespaces/. Trate como seu PC: pode criar e testar scripts, compilar código, instalar pacotes, fazer experimentos, criar arquivos e entregá-los ao usuário.",
    "Ações do codespace:",
    "- Executar qualquer comando shell/bash no seu PC: [FWP_ACTION]{\"type\":\"shell_exec\",\"command\":\"echo hello world\"}[/FWP_ACTION]",
    "- Escrever/criar um arquivo no seu PC: [FWP_ACTION]{\"type\":\"cs_write_file\",\"path\":\"script.py\",\"content\":\"print('hello')\"}[/FWP_ACTION]",
    "- Ler um arquivo do seu PC: [FWP_ACTION]{\"type\":\"cs_read_file\",\"path\":\"script.py\"}[/FWP_ACTION]",
    "- Listar arquivos do seu PC: [FWP_ACTION]{\"type\":\"cs_list_files\"}[/FWP_ACTION]",
    "- Enviar um arquivo para o usuário no Discord: [FWP_ACTION]{\"type\":\"cs_send_file\",\"path\":\"resultado.txt\"}[/FWP_ACTION]",
    "REGRAS DO CODESPACE:",
    "- O working directory de shell_exec é sempre src/fawers_codespaces/ (seu PC). Paths relativos funcionam diretamente.",
    "- Você pode encadear ações: escrever um arquivo, executá-lo com shell_exec, e depois enviar o resultado com cs_send_file.",
    "- Comandos têm timeout de 30 segundos.",
    "- Pode instalar pacotes com apt, pip, npm, curl, wget — é seu PC, faça o que quiser.",
    "- Quando o usuário pedir um arquivo, script, ou resultado de execução, use cs_send_file para entregar diretamente no chat.",
